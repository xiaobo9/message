...
public class AccessFilter implements Filter {
    ...
    private Set<String> excludes = Sets.newHashSet("/css", "/images", "/js", "/favicon.ico");
    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain filterChain) throws IOException, ServletException {
        ...
        if (REDIRECT.equals(uri)) {
            String location = redirectUrl(request);
        ...
        if (uri.endsWith(REDIRECT)) {
            log.info("{} {} 访问了 {} {} {}", request.getRemoteAddr(), remoteIpAddr, serverName, uri, redirectUrl(request));
        } else {
